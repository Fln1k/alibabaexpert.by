...
<body>
    ...
    <div class="parallax-window" data-parallax="scroll" data-z-index="1" data-image-src="img/Port_of_Manila.jpg">
        <div class="container-fluid" id="fixed1">

            <div class="row ">
                <div class="col-lg-12 ">
                    <div class="banner text-center ">
                        <p style="font-size: 30px;font-weight: 600;padding-top: 110px; ">ПОДКЛЮЧЕНИЕ И ПРОДВИЖЕНИЕ КОМПАНИЙ НА ALIBABA.COM</p>
                        <h1 style="font-size: 50px; ">МЫ ЗАПУСКАЕМ МЕЖДУНАРОДНЫЕ ПРОДАЖИ</h1>
                        <p style="font-size: 30px;padding-bottom: 100px; ">в течени месяца открываем доступ к <span style="color: #ff6a24;font-size: 37px; font-weight: 800; ">160 миллионам</span> онлайн-покупателей со всего мира</p>
                    </div>
                </div>
    ...
    <div class="parallax-window1" data-parallax="scroll" data-z-index="1" data-image-src="img/office_banner.jpg">
    ...
    <div class="parallax-window2" data-parallax="scroll" data-z-index="1" data-image-src="img/zach-heiberg-CGCsdy7aZTc-unsplash.jpg">
                    ...
                    <div id="content">
                        <div class="table-responsive" style="max-width: 100%; overflow: auto;">
                            <table cellpadding="0" cellspacing="0" width="100%" class="lite-table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td4  font12 color3">Для покупателей или продавцов<br>(без возможности ведения торговой деятельности)
                                        </td>
                                    </tr>
                                    <tr class="price">
                            ...
                            90% покупателей будут просматривать только первые 3 страницы результатов поиска">Приоритет ранжирования<i class="fas fa-angle-right" style="padding-left: 7px;"></i></td>
                                        ...
                                        <td class="td4 color3">Последние</td>
                                    </tr>
                            ...
                            Витрина продукта-это хорошо для бизнеса, чтобы получить более чем в 100 раз больше кликов покупателя">Витринных товаров<i class="fas fa-angle-right" style="padding-left: 7px;"></i></td>
                                        ...
                                        <td class="td4 bold color3">нет</td>
                                    </tr>
                                    <tr>
                            ...
                            * Сертификаты компании">Индивидуальный сайт<i class="fas fa-angle-right" style="padding-left: 7px;"></i></td>
                            ...
                            Размер ёмкости для фотографий 150мб = 50 фото продукта (3МБ / фото)">Размер фотобанка<i class="fas fa-angle-right" style="padding-left: 7px;"></i></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td4 td5 color3"><a href="reg.php?type=Free" class="lite-btn white-btn">Подать заявку</a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
